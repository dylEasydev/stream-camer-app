    ...
    async findAudio(req:Request , res:Response){
        try {
            ...
            if(req.query.search){
                ...
                const tbaleVideo = await viewService.findAllAudio(usertoken.userId,limit , search);
                return statusResponse.sendResponseJson(
            ...
            const tbaleVideo = await viewService.findAllAudio(usertoken.userId,limit);
            return statusResponse.sendResponseJson(
                CodeStatut.VALID_STATUS,
                res,
    ...
    async findVideo(req:Request , res:Response){
        try {
            ...
            if(req.query.search){
                ...
                const tbaleVideo = await viewService.findAllVideo(usertoken.userId,limit , search);
                return statusResponse.sendResponseJson(
                    CodeStatut.VALID_STATUS,
                    res,
            ...
            const tbaleVideo = await viewService.findAllVideo(usertoken.userId,limit);
            return statusResponse.sendResponseJson(
                CodeStatut.VALID_STATUS,
                res,
